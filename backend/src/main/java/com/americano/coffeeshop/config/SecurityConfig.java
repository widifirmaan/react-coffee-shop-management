...
public class SecurityConfig {
    ...
    @org.springframework.beans.factory.annotation.Value("${ALLOWED_ORIGINS:http://localhost:5173,http://localhost:3000,http://localhost:8085,https://vps.widifirmaan.web.id,http://vps.widifirmaan.web.id,https://nyafe.widifirmaan.web.id,http://nyafe.widifirmaan.web.id}")
